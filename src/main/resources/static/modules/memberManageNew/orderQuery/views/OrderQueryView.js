define(['hbs!../templates/orderquery.html'], function (temp) {
        var pageView = fish.View.extend({
            ...
            afterRender: function () {
                ...
                var option = {
					...
					columns: [
						...
						{data: "status_date", title: "状态时间", width: "25%"},
						{data: "order_status", title: "状态", width: "10%",
            ...
            queryBusiOrder:function(page,rows){
            	...
            	fish.callService("BusiOrderNewController", "queryBusiOrder",param,function(reply){
            ...
            showDetailView:function(params){
                ...
                that.requireView({
                    ...
                    url:"modules/memberManageNew/orderQuery/views/OrderDetailQueryView",
