define(['hbs!../templates/selectSetMeal.html',"../../../busiGroupOrder/views/Prod_add_page","../../../busiGroupOrder/views/Prod_add_page","../../../busiGroupOrder/views/select_value_util"],function(temp) {
    var pageView = fish.View.extend({
            ...
            if (total > 0) {
                ...
                $("#prod_list").find("li").each(function(index,ele){
    				$(ele).find("input:first").unbind("click").bind("click",function(e){
    					...
    					/*if($(ele).find("div").hasClass("checked")){
    					if($(ele).find("div").hasClass("checked")){*/
		...
		confirmSubmitOrder:function(order_info){
			...
			layer.confirm("确认提交？",function(index){
	        	...
	        	params.cache_key = that.parentView.order_info.cache_key;
	        	params.has_test_prod = that.has_test_prod;
	        	params.order_exp_type = that.order_exp_type;
	        	layer.close(index);
	        	fish.callService("BusiOrderNewController", "submitMemModifyOrder", params,function(data) {
