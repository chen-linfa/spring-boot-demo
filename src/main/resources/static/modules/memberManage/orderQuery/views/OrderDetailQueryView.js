define(['hbs!../templates/orderdetail.html'], function (temp) {
        var pageView = fish.View.extend({
            ...
            afterRender: function () {
                ...
                var option = {
					...
					columns: [
						...
						{data: "busi_type", title: "业务", width: "10%",code:"BUSI_TYPE"},
						{data: "prod_name", title: "产品套餐", width: "20%"},
						{data: "status_date", title: "状态时间", width: "20%"},
						{data: "order_detail_status", title: "状态", width:"10%",code:"ORDER_DETAIL_STATUS"},
            ...
            queryMemberInfo:function(page,rows){
            	...
            	fish.callService("BusiOrderController", "queryBusiOrderDetail",param,function(reply){
