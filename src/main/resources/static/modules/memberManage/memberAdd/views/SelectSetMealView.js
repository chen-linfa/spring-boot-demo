define(['hbs!../templates/selectSetMeal.html',"../../../busiGroupOrder/views/select_value_util"],function(temp) {
    var pageView = fish.View.extend({
		...
		confirmSubmitOrder:function(order_info){
			var that = this;
			//实际提交订单
			layer.confirm("确认提交？",{autoClose: true,yes:function(index){
				var params = {};
	        	params.order_info = order_info;
	        	params.cache_key = that.parentView.order_info.cache_key;
	        	
	        	fish.callService("BusiOrderController", "submitMemAddOrder", params,function(data) {
