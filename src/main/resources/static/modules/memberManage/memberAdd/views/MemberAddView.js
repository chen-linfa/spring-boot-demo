            ...
            controlDivChange:function(phase,param){
            	...
            	case 1:
            		...
            		that.requireView({
            			...
            			url:"modules/memberManage/memberAdd/views/SelectNumberView"
            		});
            		break;
            	case 2:
            		//2:选套餐
            		that.requireView({
            			selector:".js-controldiv",
            			url:"modules/memberManage/memberAdd/views/SelectSetMealView"
            		});
            		break;
            	case 3:
            		//3:完成
            		that.requireView({
            			selector:".js-controldiv",
            			url:"modules/memberManage/memberAdd/views/FinishView",
            			viewOption:param
            		});
            		break;
            	default:
